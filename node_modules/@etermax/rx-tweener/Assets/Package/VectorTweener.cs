...
namespace Etermax.Rx.UnityDelivery.Widgets {
	public abstract class VectorTweener : MonoBehaviour {
		public Vector3 from = new Vector3(1f, 1f, 1f);
		public Vector3 to = new Vector3(1.5f, 1.5f, 1.5f);
		...
		public IObservable<Vector3> Tween()
		{
		...
		IObservable<Vector3> CreateTween()
		{
