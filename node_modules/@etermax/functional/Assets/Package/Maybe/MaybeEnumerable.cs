...
namespace Functional.Maybe
{
    ...
    public static class MaybeEnumerable
    {
        ...
        /// <returns></returns>
        public static IEnumerable<Maybe<TResult>> Select<T, TResult>(this IEnumerable<Maybe<T>> maybes,
        ...
        /// <param name="fn"></param>
        /// <returns></returns>
        public static IEnumerable<TResult> SelectWhereValueExist<T, TResult>(this IEnumerable<Maybe<T>> maybes,
            Func<T, TResult> fn)
        {
    ...
    /// <summary>
    /// Integration with Queue's LINQ (such as .DequeueMaybe()) and all kinds of cross-use of Queue and Maybes
    /// </summary>
    public static class MaybeQueue
    {
        /// <summary>
        /// Returns the first element of the queue or Nothing
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="items"></param>
        /// <returns></returns>
        public static Maybe<T> DequeueMaybe<T>(this Queue<T> items)
        {
            return !items.Any() ? Maybe<T>.Nothing : items.Dequeue().ToMaybe();
        }
    }
}