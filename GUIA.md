...
`Vector3 GetPositionFor(FieldPosition)` -> Retorna la posición de un cuadrante (*FieldPosition*) dado.
 
`void GoTo(FieldPosition)` -> Mueve al jugador hacia el cuadrante (*FieldPosition*) específico y se detiene al llegar al mismo.
